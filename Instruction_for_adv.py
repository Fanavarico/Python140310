...
'''
12 jan new L1 [-------- Attend ----------]
19 jan new L1 [--------Non-Attend ----------]
26 jan new L2 [-------- Attend----------]
2 feb new L2  [--------Non-Attend ----------]
...
ta send ro nazani
hashtag comment and qout

first python built in --> print, inptu and .....len , type and ....
second --> grammars
third---> variables (zarf)

numbers, operations , compariosn , logical and .....
int, float and .....
first and tehn (writing)



str ----> str jomle frghesh ba adad str and .....
badesh access -> [] chantaee badesh chijori taghir hazf va ..
badesh str functions
lower
upper
replace
strip
